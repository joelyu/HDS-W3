...
Mean z-scored immune cell type profiles for k-means clusters. <br> **Left**: `r optimal_k` clusters from all 14 cell types. <br> **Right**: `r sig_optimal_k` clusters from the 4 PAM50-adjusted significant cell types only. Clusters labelled by overall immune level. Red = above-average infiltration; blue = below-average.
:::
:::
