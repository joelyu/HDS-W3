...
Still, several limitations should be noted. The METABRIC expression data were generated on the Illumina HT-12 v3 microarray, an older platform that captured 58 of 60 immune marker genes. Certain cell types relied on single-gene markers ([Table S1](#panel-tbl-s1)), which may limit sensitivity for these cell types. Treatment type data were available on cBioPortal but were not modelled as covariates in this analysis. As treatment assignment in breast cancer is subtype-dependent, treatment effects on immune infiltration and prognosis remain an unaddressed confounder. Finally, the gene expression data were at a single timepoint, failing to capture the immune dynamics over the course of the disease.
