# HDS Module 3 — Immune Cell Infiltration in METABRIC

Exploratory and integrative analysis of the METABRIC breast cancer dataset, focusing on immune cell infiltration across PAM50 subtypes using Danaher et al. (2017) marker gene scoring.

**Author**: Yu Chung Yan (cyy36)
